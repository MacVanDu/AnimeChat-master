...
package com.example.dumvanimechat.view.spacetablayout;
...
public class SpaceTabLayout extends RelativeLayout {
    ...
    private void init() {
        ...
        defaultTabOneButtonIcon = getContext().getResources().getDrawable(R.drawable.user);
        defaultTabTwoButtonIcon = getContext().getResources().getDrawable(R.drawable.chat);
        defaultTabThreeButtonIcon = getContext().getResources().getDrawable(R.drawable.coin);
